...
public class StartedServiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // exercise 8a - create an instance of the StartedServiceBroadcastReceiver broadcast receiver
        startedServiceBroadcastReceiver = new StartedServiceBroadcastReceiver(messageTextView);

        // exercise 8b - create an instance of an IntentFilter
    ...
    protected void onResume() {
        ...
        // exercise 8c - register the broadcast receiver with the corresponding intent filter
        registerReceiver(startedServiceBroadcastReceiver, startedServiceIntentFilter);
    }

    @Override
    protected void onPause() {
        // exercise 8c - unregister the broadcast receiver
    ...
    // exercise 9 - implement the onNewIntent callback method
