...
public class PracticalTest01Var03MainActivity extends AppCompatActivity {
            ...
            plus_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (first_number.matches("[0-9]+") && second_number.matches("[0-9]+")) {
                        ...
                        if(started == 0) {
                            started = 1;
                            serviceIntent.putExtra("ro.pub.cs.systems.eim.practicaltest01var03.FIRST_NUMBER", first_number_edit_text.getText().toString());
                            serviceIntent.putExtra("ro.pub.cs.systems.eim.practicaltest01var03.SECOND_NUMBER", second_number_edit_text.getText().toString());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startedServiceIntentFilter.addAction(ServiceConstants.ACTION_SUM);
        startedServiceIntentFilter.addAction(ServiceConstants.ACTION_DIF);
    ...
    protected void onDestroy() {
        ...
        intent.setComponent(new ComponentName("ro.pub.cs.systems.eim.practicaltest01var03", "ro.pub.cs.systems.eim.practicaltest01var03.service.PracticalTest01Var03Service"));
        stopService(intent);
    ...
    protected void onNewIntent(Intent intent) {
        ...
        Log.d(ServiceConstants.SERVICE, "[service] on new intent: " + data);
    }
