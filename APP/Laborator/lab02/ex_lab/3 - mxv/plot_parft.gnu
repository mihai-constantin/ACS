...
plot 'parft_1_procs.dat' using 3:4\
     title 'Row Autopar (first touch) - 1 proc' with linespoints linetype 1, \
     'parft_2_procs.dat' using 3:4\
     title 'Row Autopar (first touch) - 2 procs' with linespoints linetype 2

pause -1 'Press <Return> to plot data for the column version'

plot 'parft_1_procs.dat' using 3:5\
     title 'Column Autopar (first touch) - 1 proc' with linespoints linetype 1, \
     'parft_2_procs.dat' using 3:5\
     title 'Column Autopar (first touch) - 2 procs' with linespoints linetype 2

pause -1 'Press <Return> to plot data for the PerfLib version'

plot 'parft_1_procs.dat' using 3:6\
     title 'Library version (first touch) - 1 proc' with linespoints linetype 1, \
     'parft_2_procs.dat' using 3:6\
     title 'Library version (first touch) - 2 procs' with linespoints linetype 2

pause -1 'Press <Return> to compare data - row version - single proc'

plot 'serial.dat' using 3:4\
     title 'Row - serial version' with linespoints linetype 1, \
     'par_1_procs.dat' using 3:4\
     title 'Row Autopar - 1 proc' with linespoints linetype 2, \
     'parft_1_procs.dat' using 3:4\
     title 'Row Autopar (first touch) - 1 proc' with linespoints linetype 3

pause -1 'Press <Return> to compare data - row version - two procs'

plot 'par_2_procs.dat' using 3:4\
     title 'Row Autopar - 2 procs' with linespoints linetype 1, \
     'parft_2_procs.dat' using 3:4\
     title 'Row Autopar (first touch) - 2 procs' with linespoints linetype 2
...
plot 'serial.dat' using 3:5\
     title 'Column - serial version' with linespoints linetype 1, \
     'par_1_procs.dat' using 3:5\
     title 'Column Autopar - 1 proc' with linespoints linetype 2, \
     'parft_1_procs.dat' using 3:5\
     title 'Column Autopar (first touch) - 1 proc' with linespoints linetype 3

pause -1 'Press <Return> to compare data - column version - two procs'

plot 'par_2_procs.dat' using 3:5\
     title 'Column Autopar - 2 procs' with linespoints linetype 1, \
     'parft_2_procs.dat' using 3:5\
     title 'Column Autopar (first touch) - 2 procs' with linespoints linetype 2
...
plot 'par_1_procs.dat' using 3:6\
     title 'Library version - 1 proc' with linespoints linetype 1, \
     'parft_1_procs.dat' using 3:6\
     title 'Library version (first touch) - 1 proc' with linespoints linetype 2

pause -1 'Press <Return> to compare data - library version - two procs'

plot 'par_2_procs.dat' using 3:6\
     title 'Library version - 2 procs' with linespoints linetype 1, \
     'parft_2_procs.dat' using 3:6\
     title 'Library version (first touch) - 2 procs' with linespoints linetype 2
