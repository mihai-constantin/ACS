...
import observers.ObstacleDiscoverer;
            ...
            switch (cmdTokens[0]) {
                ...
                case "add":
                    ...
                    try {
                        ...
                        Hero hero = HeroFactory.getInstance().createHero(heroType, cmdTokens[2]);
                        gs.getParty().add(hero);
                ...
                case "start":
                    ...
                    if (!gs.isAdventureStarted()) {
                        ...
                        gs.addObserver(new ObstacleDiscoverer());
