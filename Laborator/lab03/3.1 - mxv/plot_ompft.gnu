...
plot 'ompft_1_procs.dat' using 3:4\
     title 'Row OpenMP (first touch) - 1 proc' with linespoints linetype 1, \
     'ompft_2_procs.dat' using 3:4\
     title 'Row OpenMP (first touch) - 2 procs' with linespoints linetype 2

pause -1 'Press <Return> to plot data for the column version'

plot 'ompft_1_procs.dat' using 3:5\
     title 'Column OpenMP (first touch) - 1 proc' with linespoints linetype 1, \
     'ompft_2_procs.dat' using 3:5\
     title 'Column OpenMP (first touch) - 2 procs' with linespoints linetype 2
...
plot 'serial.dat' using 3:4\
     ...
     title 'Row OpenMP - 1 proc' with linespoints linetype 2, \
     'ompft_1_procs.dat' using 3:4\
     title 'Row OpenMP (first touch) - 1 proc' with linespoints linetype 3
...
plot 'serial.dat' using 3:5\
     ...
     title 'Column OpenMP - 1 proc' with linespoints linetype 2, \
     'ompft_1_procs.dat' using 3:5\
     title 'Column OpenMP (first touch) - 1 proc' with linespoints linetype 3

pause -1 'Press <Return> to compare data - column version - two procs'

plot 'omp_2_procs.dat' using 3:5\
     title 'Column OpenMP - 2 procs' with linespoints linetype 1, \
     'ompft_2_procs.dat' using 3:5\
     title 'Column OpenMP (first touch) - 2 procs' with linespoints linetype 2
