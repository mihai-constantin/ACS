...
plot 'ompth_1_procs.dat' using 3:4\
     title 'Row OpenMP (threshold) - 1 proc' with linespoints linetype 1, \
     'ompth_2_procs.dat' using 3:4\
     title 'Row OpenMP (threshold) - 2 procs' with linespoints linetype 2

pause -1 'Press <Return> to plot data for the column version'

plot 'ompth_1_procs.dat' using 3:5\
     title 'Column OpenMP (threshold) - 1 proc' with linespoints linetype 1, \
     'ompth_2_procs.dat' using 3:5\
     title 'Column OpenMP (threshold) - 2 procs' with linespoints linetype 2
...
plot 'serial.dat' using 3:4\
     ...
     title 'Row OpenMP (threshold) - 1 proc' with linespoints linetype 3
