...
plot 'omp_1_procs.dat' using 3:4\
     title 'Row OpenMP - 1 proc' with linespoints linetype 1, \
     'omp_2_procs.dat' using 3:4\
     title 'Row OpenMP - 2 procs' with linespoints linetype 2

pause -1 'Press <Return> to plot data for the column version'

plot 'omp_1_procs.dat' using 3:5\
     title 'Column OpenMP - 1 proc' with linespoints linetype 1, \
     'omp_2_procs.dat' using 3:5\
     title 'Column OpenMP - 2 procs' with linespoints linetype 2
...
plot 'serial.dat' using 3:4\
     ...
     title 'Row OpenMP - 1 proc' with linespoints linetype 3
...
plot 'serial.dat' using 3:5\
     ...
     title 'Column OpenMP - 1 proc' with linespoints linetype 3
...
plot 'omp_1_procs.dat' using 3:4\
     ...
     title 'Column OpenMP - 1 proc' with linespoints linetype 3, \
     'par_1_procs.dat' using 3:5\
     title 'Column autopar - 1 proc' with linespoints linetype 4, \
     'omp_1_procs.dat' using 3:6\
     title 'Parallel library version - 1 proc' with linespoints linetype 5

pause -1 'Press <Return> to compare data - two processors'

plot 'omp_2_procs.dat' using 3:4\
     title 'Row OpenMP - 2 procs' with linespoints linetype 1, \
     'par_2_procs.dat' using 3:4\
     title 'Row autopar - 2 procs' with linespoints linetype 2, \
     'omp_2_procs.dat' using 3:5\
     title 'Column OpenMP - 2 procs' with linespoints linetype 3, \
     'par_2_procs.dat' using 3:5\
     title 'Column autopar - 2 procs' with linespoints linetype 4, \
     'omp_2_procs.dat' using 3:6\
     title 'Parallel library version - 2 procs' with linespoints linetype 5
