...
plot 'par_1_procs.dat' using 3:4\
     title 'Row Autopar - 1 proc' with linespoints linetype 1, \
...
plot 'par_1_procs.dat' using 3:5\
     title 'Column Autopar - 1 proc' with linespoints linetype 1, \
     'par_2_procs.dat' using 3:5\
     title 'Column Autopar - 2 procs' with linespoints linetype 2

pause -1 'Press <Return> to plot data for the library version'

plot 'par_1_procs.dat' using 3:6\
     title 'Parallel library version - 1 proc' with linespoints linetype 1, \
     'par_2_procs.dat' using 3:6\
     title 'Parallel library version - 2 procs' with linespoints linetype 2
...
plot 'par_1_procs.dat' using 3:4\
     ...
     title 'Parallel library version - 1 proc' with linespoints linetype 3
...
plot 'par_2_procs.dat' using 3:4\
     ...
     title 'Column Autopar - 2 procs' with linespoints linetype 2, \
     'par_2_procs.dat' using 3:6\
     title 'Parallel library version - 2 procs' with linespoints linetype 3
