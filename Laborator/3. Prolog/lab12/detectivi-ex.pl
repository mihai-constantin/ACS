...
arme_bmw(ListaArme) :- findall(Y, suspect(_:bmw:Y), ListaArme).
...
au_marca1(Marca, ListaNume) :- findall(X, (suspect1(X: Marca:_), conduce(X, Marca)), ListaNume).
...
check7:- tests([
            ...
            [aurel:ford:sabie,bogdan:bmw:pistol,cosmin:bmw:arbaleta,
             ...
             marian:mercedes:cutit,nicodim:opel:prastie,paul:honda:sabie])])
          ]).
...
suspect2(Nume:Marca:Arma) :-
    suspect1(Nume:Marca:Arma),
    \+ au_marca1(Marca, [Nume]).

au_arma2(Arma, ListaNume) :- findall(X, (suspect2(X:_:Arma), inarmat(X, Arma)), ListaNume).
...
au_marca3(Marca, ListaNume) :- findall(X, (suspect3(X:Marca:_), conduce(X, Marca)), ListaNume).
...
suspect4(Nume:Marca:Arma) :-
    suspect3(Nume:Marca:Arma),
    \+ au_marca3(Marca, [Nume]).

au_arma4(Arma, ListaNume) :- findall(X, (suspect4(X:_:Arma), inarmat(X, Arma)), ListaNume).
...
au_marca5(Marca, ListaNume) :- findall(X, (suspect5(X:Marca:_), conduce(X, Marca)), ListaNume).
