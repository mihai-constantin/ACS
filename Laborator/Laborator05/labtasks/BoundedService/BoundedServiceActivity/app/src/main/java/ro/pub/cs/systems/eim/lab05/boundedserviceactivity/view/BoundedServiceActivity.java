...
public class BoundedServiceActivity extends AppCompatActivity {
    ...
    private GetMessageFromServiceButtonListener mGetMessageFromServiceButtonListener = new GetMessageFromServiceButtonListener();

    // exercise 10e - implement a button click listener for getMessageFromServiceButton
    public class GetMessageFromServiceButtonListener implements View.OnClickListener {
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getMessageFromServiceButton.setOnClickListener(mGetMessageFromServiceButtonListener);
    }
