...
public class ServerThread extends Thread {
    ...
    private HashMap<String, BITInformation> data = null;
    ...
    public synchronized void setData(String city, BITInformation bitInformation) {
        this.data.put(city, bitInformation);
    }

    public synchronized HashMap<String, BITInformation> getData() {
        return data;
    }
