...
plot 'serial.dat' using 3:4\
     title 'Row - compiler optimized' with linespoints linetype 1, \
     'serial.dat' using 3:5\
     title 'Column - compiler optimized' with linespoints linetype 2, \
     'serial.dat' using 3:6\
     title 'Library version' with linespoints linetype 3

pause -1 'Press <Return> to compare performance - row version'

plot 'base.dat' using 3:4\
     title 'Row - not optimized' with linespoints linetype 1, \
     'serial.dat' using 3:4\
     title 'Row - compiler optimized' with linespoints linetype 2

pause -1 'Press <Return> to compare performance - column version'

plot 'base.dat' using 3:5\
     title 'Column - not optimized' with linespoints linetype 1, \
     'serial.dat' using 3:5\
     title 'Column - compiler optimized' with linespoints linetype 2
